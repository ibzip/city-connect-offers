  ...
  return (
    <Section>
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-ink-muted">Consumer-side explainability for the latest real orchestration run.</p>
      </div>
      <div className="grid gap-5 lg:grid-cols-2">
        <JsonPanel title="Negotiation Brief" data={lastRun?.negotiationBrief} />
        <JsonPanel title="Decision" data={lastRun?.negotiationDecision} />
        <JsonPanel title="Validation" data={lastRun?.validationResult} />
