...
export const metadata: Metadata = {
  title: "City Wallet",
  description: "Consumer wallet for the City Wallet local-commerce MVP",
};
          ...
          <div className="mx-auto flex max-w-[1400px] items-center justify-between px-5 py-4 sm:px-6">
            <Link href="/wallet" className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="mt-1 font-mono text-[10px] uppercase tracking-[0.18em] text-ink-muted">Consumer wallet</div>
              </div>
            </Link>
            <nav className="flex gap-1 text-sm font-medium">
              <Link className="rounded-full px-3 py-1.5 text-ink-muted hover:bg-black/5" href="/wallet">Wallet</Link>
              <Link className="rounded-full px-3 py-1.5 text-ink-muted hover:bg-black/5" href="/redeem">Redeem</Link>
